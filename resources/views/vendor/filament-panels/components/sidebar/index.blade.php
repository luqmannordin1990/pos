    ...
    >
        ...
        <ul class="fi-sidebar-nav-groups -mx-2 flex flex-col gap-y-7">
            ...
            <li class="fi-sidebar-item">
                <a href="{{ route('logout', ['team' => filament()->getTenant()->slug]) }}" wire:navigate=""
                    ...
                    <!--[if BLOCK]><![endif]--> <svg class="fi-sidebar-item-icon h-6 w-6 text-gray-400 dark:text-gray-500"
                    ...
                    <span x-show="$store.sidebar.isOpen" x-transition:enter="lg:transition lg:delay-100"
                        x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                        class="fi-sidebar-item-label flex-1 truncate text-sm font-medium text-gray-700 dark:text-gray-200"> Logout
                    </span>
                </a>
            </li>
            @endif
